...
\textbf{Amazon}\hfill\textbf{October 2021 -- Present}\\
\textbf{Software Development Engineer}\hfill
\vspace{-3mm}\\\vspace{-1mm}
\begin{list2}
    \item Built and maintained systems relevant to advertising attribution
    \item Designed performance fixes for a mission critical, high volume system
    \item Built tools for operational excellence and load testing
\end{list2}
...
\begin{list2}
    ...
    \item Built an order notes feature for a production order management system
	\item Built and maintained core app services for an order management system using Go and Python based on Kubernetes and Flux
...
Haskell\\
\textbf{Technologies:} gRPC, git, Kubernetes, Docker/Containers, Spark\\
